...
namespace Screener
{
    public partial class SelectArea : Form
    {
        ...
        public void SaveSelection(bool showCursor)
        {
           ...
           var _ScreenRecorder = new ScreenRecorder();
            ...
            try
            {
                _ScreenRecorder.UpdateArea(CurrentTopLeft.X, CurrentTopLeft.Y, CurrentBottomRight.X - CurrentTopLeft.X, CurrentBottomRight.Y - CurrentTopLeft.Y);
